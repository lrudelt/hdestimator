                ...
                if not analysis_results == None:
                    ...
                    if not len(R)==0:
                        ...
                        if not R_tot_analysis_results == None:
                            ...
                            print('CI_fail',rec_length, run_index, neuron_index, sample_index)
                    else:
                        print('no valid embeddings')
                else:
                    print('analysis_fail',rec_length, run_index, neuron_index, sample_index)
    ...
    for j in range(2):
        ...
        for k in range(len(rec_lengths)):
            if j == 0:
                ...
                ax.set_ylim((85, 105.5))
                ax.spines['top'].set_bounds(85, 105)
            else:
            ...
            if not recorded_system == 'EC':
                ...
                ax.errorbar(x=rec_length_values[k], y= median_val_bbc, yerr= [[-median_CI_lo_bbc],[median_CI_hi_bbc]],
                            color= main_red, marker='d', markersize=5.)
